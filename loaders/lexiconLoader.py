...
if __name__ == "__main__":
    ...
    print("Sample entries Lexicon: ", list(lexicon.items())[:5])  # shows first 5 items from lexicon
    print("Sample entries Lexicon_Postings: ", list(lexicon_postings.items())[:5])  # shows first 5 items from lexicon_postings